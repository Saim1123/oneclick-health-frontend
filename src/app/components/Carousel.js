     ...
     <div className="relative w-full glide-04">
        ...
        <div className="overflow-hidden" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <img
                src="https://www.shifaam.com/uploads/slider/PHARHP.jpg"
                className="w-full max-w-full h-[300px] m-auto object-cover"
              />
            </li>
            <li>
              <img
                src="https://www.shifaam.com/uploads/slider/WESHP.jpg"
                className="w-full max-w-full h-[300px] m-auto object-cover"
              />
            </li>
            <li>
              <img
                src="https://www.shifaam.com/uploads/slider/Webbanner.jpg"
                className="w-full max-w-full h-[300px] m-auto object-cover"
              />
            </li>
            <li>
              <img
                src="https://www.shifaam.com/uploads/slider/VACHP.jpg"
                className="w-full max-w-full h-[300px] m-auto object-cover"
              />
            </li>
            <li>
              <img
                src="https://www.shifaam.com/uploads/slider/DOCHP.jpg"
                className="w-full max-w-full h-[300px] m-auto object-cover"
              />
            </li>
          </ul>
