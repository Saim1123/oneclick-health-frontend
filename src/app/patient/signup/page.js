...
const page = () => {
    ...
    return (
        <div className='bg-gray-100 py-20 flex justify-center'>
            <form onSubmit={handleSubmit(onSubmit)} className='bg-white w-[400px] rounded-md shadow-xl px-6 py-8'>
                <h2 className='text-2xl font-bold text-[#c30404] mb-4'>Patient Signup</h2>

                <label htmlFor='firstName' className=''>First Name</label>

                {errors.firstName && <p className='bg-red-300 p-2 rounded-md'>firstName is required</p>}
                ...
                {errors.lastName && <p className='bg-red-300 p-2 rounded-md'>lastName is required</p>}
                ...
                {errors.number && <p className='bg-red-300 p-2 rounded-md'>number is required</p>}
                ...
                {errors.verifyCode && <p className='bg-red-300 p-2 rounded-md'>code is required</p>}
                ...
                {errors.password && <p className='bg-red-300 p-2 rounded-md'>password is required</p>}
