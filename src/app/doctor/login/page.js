        ...
        <>
            <div className='bg-gray-100 py-20 flex justify-center'>
                <div className='bg-white w-[400px] rounded-md shadow-xl px-6 py-8'>
                    ...
                    <input type='number' id='nmb' placeholder="0301 2345678" required className="bg-transparent mt-1 mb-8 outline-none border border-gray-300 focus:border-[#c30404] focus:outline-none focus:shadow-md px-4 py-2 w-full rounded-md" />
                    <label htmlFor='pwd' className=''>Password</label>
                    <input type='password' id='pwd' placeholder="Password" required className="bg-transparent mt-1 mb-2 outline-none border border-gray-300 focus:border-[#c30404] focus:outline-none focus:shadow-md px-4 py-2 w-full rounded-md" />
                    ...
                    <div className='flex justify-center mt-4'>
                        <p className='text-sm text-gray-500 font-medium '>Don't have an account? <Link href="/doctor/signup" className='text-[#c30404] hover:cursor-pointer'>Sign up here</Link></p>
                    </div>
                </div>
            </div>
        </>
